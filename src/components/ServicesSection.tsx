  ...
  const services = [
    {
      ...
      title: "בדיקות זכויות במינהל האזרחי ובתב\"ע",
      description: "בדיקת מסמכי מקור, נסחים עות'מאניים ועיגון זכויות במינהל האזרחי, כולל זיהוי מוקדם של קרקע פרטית פלסטינית או היעדר רישום מסודר. ניסוח חוזה המותאם לאתגרים הספציפיים של האזור והבטחת האינטרסים שלכם.",
      benefits: [
        "וידוא בעלות משפטית תקפה",
        "מניעת עיכובים וביטול עסקאות",
        "חוזה מכר מותאם להגנה מירבית"
      ],
      statistic: "בדיקה של למעלה מ‑30 נקודות קריטיות לכל נכס"
    },
    {
      ...
      title: "ייעוץ פיננסי ומשכנתאות מורכבות",
      description: "ניתוח תוכנית מימון, הצגה לגורמי בנק וחוץ‑בנקאית, ובניית תיק אשראי חזק להשגת תנאי הון עצמי אופטימליים. התמודדות עם אתגרי המימון הייחודיים ליהודה ושומרון וגיוס משכנתא גם במקרים מורכבים.",
      benefits: [
        "גיוס מימון מותאם אישית",
        "חיסכון משמעותי בריבית ועלויות",
        "ליווי ועדכון שוטף מול המוסד הפיננסי"
      ],
      statistic: "סיוע בהשגת מימון בתנאי הון עצמי נמוכים מ‑30% במקרים מורכבים"
    },
    {
      ...
      title: "רישום והעברת זכויות במינהל האזרחי",
      description: "טיפול בהגשה ונוטריונים, דיווח מס רכישה ושבח, ושיתוף פעולה עם חברות משכנות לסיום מהיר ובטוח של התהליך. ליווי צמוד בתהליך הרישום הייחודי במנהל האזרחי והתמודדות עם הבירוקרטיה המורכבת של האזור.",
      benefits: [
        "ביטחון משפטי מלא",
        "טיפול מקיף במס רכישה ושבח",
        "העברת זכויות מהירה ומקצועית"
      ],
      statistic: "100% הצלחה ברישום מוקדם ובטוח ללא עיכובים"
    }
  ];
    ...
    <section id="services" className="section-padding py-16 bg-primary-light relative">
      <div className="container mx-auto px-5 md:px-8">
        <AnimatedBox animation="fadeIn">
          <h2 className="section-title text-center mx-auto text-3xl md:text-5xl mb-3 flex justify-center">שירותי המפתח שלנו לעסקאות ביהודה ושומרון</h2>
          <p className="text-center text-lg text-black/80 max-w-3xl mx-auto">
            מלווים אתכם בכל שלב – מהגשת הבקשה למינהל האזרחי ועד רישום רשמי והעברת זכויות.
          </p>
        </AnimatedBox>
